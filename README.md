# 안양 에버포레 자연& e편한세상 (A2BL) 안내 사이트

국민주택(공공분양) 입주자모집공고를 알기 쉽게 정리한 **정적 웹사이트**입니다.
서버 없이 GitHub Pages에서 그대로 동작합니다.

🔗 https://garsu-garsu.github.io/anyang-everfore-nature-e-life/
...
이 사이트는 [everfore-site-builder 스킬](#)로 생성되었습니다.
