...
document.addEventListener("data:ready", (e) => {
  ...
  const Q = [
    { key: "resi", q: "현재 거주지와 거주 기간은?", help: "입주자모집공고일(2026.04.30) 기준입니다.",
      opts: [
        ["안양시 2년 이상 계속 거주 (2024.04.30 이전 전입)", "anyang2"],
        ["안양시 2년 미만 거주", "anyang0"],
        ["서울·인천·경기 (안양 외) 거주", "metro"],
    ...
    { key: "savings", q: "주택청약종합저축 가입 상태는?", help: "이 단지는 투기과열·청약과열지역 국민주택입니다.",
      opts: [
        ["가입 24개월 경과 + 24회 이상 납입", "s24"],
        ["가입했지만 24개월/24회에 못 미침 (6회 이상)", "s6"],
        ["미가입 또는 6회 미만", "s0"],
      ] },
  ...
  function renderResult() {
    ...
    const region = a.resi === "anyang2" ? "해당지역(안양 2년 이상 — 1순위 우선공급)" : "기타지역(안양 2년 미만 또는 서울·인천·경기)";
